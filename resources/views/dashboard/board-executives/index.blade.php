...
@section('title', 'Board & Executives')
@section('breadcrumb')
    ...
    <div class="card py-4">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <a href="{{route('dashboard.board-executives.create')}}" class="btn btn-light-primary btn-sm">
                        Add
                    </a>
                </div>
                <!--end::Toolbar-->
        ...
        <div class="card-body pt-5">
            ...
            <div class="table-responsive">
                <table class="table table-row-bordered gy-5" id="boardExecutiveDatatable">
                    <thead>
...
@section('scripts')
    <script>
        $( document ).ready(function( $ ) {
            let table = $('#boardExecutiveDatatable').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": "{{route('dashboard.board-executives.index')}}",
                    "dataType":"json",
                    "type":"GET",
