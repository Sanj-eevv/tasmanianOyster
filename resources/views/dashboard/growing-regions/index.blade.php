    ...
    <div class="card py-4">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <a href="{{route('dashboard.growing-regions.create')}}" class="btn btn-light-primary btn-sm">
                        Add
                    </a>
                </div>
                <!--end::Toolbar-->
        ...
        <div class="card-body pt-5">
            ...
            <div class="table-responsive">
                <table class="table table-row-bordered gy-5" id="growingRegionDatatable">
                    <thead>
...
@section('scripts')
    <script>
        $( document ).ready(function( $ ) {
            let table = $('#growingRegionDatatable').DataTable({
                "serverSide": true,
                "ajax": {
                    "url": "{{route('dashboard.growing-regions.index')}}",
                    "dataType":"json",
                    "type":"GET",
